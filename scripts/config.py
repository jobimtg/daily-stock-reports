...
TAIEX_ETFS = [
    ...
    {"ticker": "00888.TW",  "name": "永豐台灣 ESG",         "category": "ESG",        "core": False},
...
REGIONS = {
    "full": {
        ...
        "output_subdir": "",                                          # repo root
        "url_path_fmt":  "daily-financial-brief-{date}.html",
    ...
    "tw": {
        ...
        "output_subdir": "tw",                                        # repo root /tw/
        "url_path_fmt":  "tw/daily-tw-brief-{date}.html",
